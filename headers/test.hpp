...
void test(){
        if (TESTELES){
                ...
                TEST(Ember, paramn.ctor)
                        Ember paramn;
                        EXPECT_EQ("", paramn.getVezetek());
                        EXPECT_EQ("", paramn.getKereszt());
                        EXPECT_EQ("", paramn.getBece());
                END     
                ...
                TEST(Ember, masol ctor es egyenloseg op)
                        ...
                        egyenlo = forras; //TODO egyaltalan van hasznalva??
                ...
                TEST(Bejegyzes, paramn.ctor)
                        ...
                        EXPECT_EQ("", test.getVezetek());
                        EXPECT_EQ("", test.getKereszt());
                        EXPECT_EQ("", test.getBece());
                ...
                Telefonkonyv test;
                test.factoryReset("files/source_backup.txt", "files/source.txt"); //ezzel allitunk mindent vissza
